...
def analyze(df,save=False):
  ...
  model_list=[
    ...
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','Us'],
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','mo_t_pi','Us'],
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','mo_t_ds','Us'],
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','mo_t_pi','mo_t_ds','Us'],
 
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','Jsd'],
    ...
    ['mo_n_3d','mo_n_2ppi','mo_n_2pz','Jsd','Us'],
