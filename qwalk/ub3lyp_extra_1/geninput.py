...
def genpbs(N,basename,fout):
  ...
  for i in range(1,N+1):
    ...
    '#PBS -e '+fname+'.perr\n'+\
    '#PBS -o '+fname+'.pout\n'+\
    'mkdir -p /scratch/sciteam/$USER/cuo/qwalk/ub3lyp_s1_/'+basename+'/\n'+\
    'cd /scratch/sciteam/$USER/cuo/qwalk/ub3lyp_s1_/'+basename+'/\n'+\
    'cp -u /u/sciteam/$USER/cuo/qwalk/ub3lyp_s1_/'+basename+'/* .\n'+\
...
def genslater(N,gsw,basestate,basename,fout):
  for j in range(1,N+1):
    ...
    '  MAGNIFY 1.0\n'+\
    '  NMO '+str(Ndet*14*2)+'\n'+\
    '  ORBFILE all_1extra.orb\n'+\
    '  INCLUDE all_1extra.basis\n'+\
    '  CENTERS { USEGLOBAL }\n'+\
    '}\n'+\
    '\n'+\
