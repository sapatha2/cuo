...
df['ind'].iloc[[12]]=12
df['ind'].iloc[[19]]=19
sns.pairplot(df,vars=['tpi','tsz','tds','tdz'],hue='ind',markers=['.']+['o']*3)
#sns.pairplot(df,vars=['nd','npi','nz','ns'],hue='ind',markers=['.']+['o']*3)
plt.savefig('dft_t.pdf',bbox_inches='tight')
#print(df[['nd','ns','nz','npi','tpi','tsz','tds','tdz']])
