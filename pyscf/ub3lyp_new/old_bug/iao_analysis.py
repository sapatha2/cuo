...
#IAO basis
b = pd.read_pickle('../ub3lyp_full/b3lyp_iao_b.pickle')
...
#print(df['tpi'])
#exit(0)
sns.pairplot(df,vars=['tpi','npi'],hue='ind',markers=['.']*17+['o']*3)
